...
Page({
  ...
  onLoad: function (options) {
    ...
    var schoolId = app.globalData.school.schoolId;
  ...
  getGoodListCallback: function(self, category) {
    ...
    self.getStructure(self, category, self.data.boxId, self.data.getInterfaceName,self.data.schoolId);
  },
  ...
  getStructure: function(self, category, boxId, interfaceName,schoolId) {
    wx.request({
  ...
  saveCommodityStructure: function(e) {
    ...
    wx.showModal({
      ...
      success: function(res) {
        if (res.confirm) {
          console.log('用户点击确定');
          self.setStructure(self, self.data.boxId, self.data.category, self.data.setInterfaceName,self.data.schoolId);
        } else if (res.cancel) {
          console.log('用户点击取消');
        }
      }
  ...
  setStructure: function(self, boxId, category, interfaceName,schoolId) {
